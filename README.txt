...
-> PyLucene (manually installation):
http://lucene.apache.org/pylucene/
http://bendemott.blogspot.ro/2013/11/installing-pylucene-4-451.html
-> cElementTree
...
-> mwparserfromhell (pip)
https://github.com/earwig/mwparserfromhell
-> beautifulsoup4 (pip)
http://www.crummy.com/software/BeautifulSoup/#Download
-> textblob_aptagger (pip)
http://honnibal.wordpress.com/2013/09/11/a-good-part-of-speechpos-tagger-in-about-200-lines-of-python/
-> nltk
http://lizusefulstuff.blogspot.ro/2012/03/how-to-install-nltk-package-for-python.html
+ download data

2. Run
Run ngram_indexer.py to index the Google Books Ngram Corpus.
After this, historical_relevance.py should be run (python historical_relevance.py or in Eclipse IDE).
